...
function getWords(page){
   ...
   $.get('/lib/daily/widgetwords.xml?page=' + page, function(data){
   
      var HTML = ""; 
      HTML +="<ul>"
      $(data).find('item').each(function(index){
          HTML = HTML + "<li>" + "<a href=\"javascript:tb_show('words','/lib/daily/words.html?serialNumber=" + $(this).find('serialNumber').text() + "&KeepThis=true&TB_iframe=true&height=600&width=600','')\">" 
...
function getNews(page){
   ...
   $.get('/lib/daily/widgetnews.xml?page=' + page, function(data){
   
      var HTML = ""; 
      HTML +="<ul>"
      $(data).find('item').each(function(index){
          HTML = HTML + "<li>" + "<a href=\"javascript:tb_show('news','/lib/daily/news.html?serialNumber=" + $(this).find('serialNumber').text() + "&KeepThis=true&TB_iframe=true&height=600&width=600','')\">" 
...
function getSongs(page){
   ...
   $.get('/lib/daily/widgetsongs.xml?page=' + page, function(data){
   
      var HTML = ""; 
      HTML +="<ul>"
      $(data).find('item').each(function(index){
          HTML = HTML + "<li>" + "<a href=\"javascript:tb_show('songs','/lib/daily/songs.html?serialNumber=" + $(this).find('serialNumber').text() + "&KeepThis=true&TB_iframe=true&height=600&width=600','')\">" 
          + (page*5+index + 1) + "." + $(this).find('title').text() + "</a>"; 
                });
      HTML +="</ul>"          
      HTML = HTML + "<br>";
...
function getWhichs(page){
   ...
   $.get('/lib/daily/widgetwhich.xml?page=' + page, function(data){
   
      var HTML = ""; 
      HTML +="<ul>"
      $(data).find('item').each(function(index){
          HTML = HTML + "<li>" + "<a href=\"javascript:tb_show('words','/lib/daily/which.html?serialNumber=" + $(this).find('serialNumber').text() + "&KeepThis=true&TB_iframe=true&height=600&width=600','')\">" 
          + (page*5+index + 1) + "." + $(this).find('title').text() + "</a>"; 
                });
      HTML +="</ul>"          
      HTML = HTML + "<br>";
...
function getVideos(page){
   ...
   $.get('/lib/daily/widgetvideo.xml?page=' + page, function(data){
   
      var HTML = ""; 
      HTML +="<ul>"
      $(data).find('item').each(function(index){
          HTML = HTML + "<li>" + "<a href=\"javascript:tb_show('words','/lib/daily/videos.html?serialNumber=" + $(this).find('serialNumber').text() + "&KeepThis=true&TB_iframe=true&height=600&width=600','')\">" 
          + (page*5+index + 1) + "." + $(this).find('title').text() + "</a>"; 
                });
      HTML +="</ul>"          
      HTML = HTML + "<br>";
