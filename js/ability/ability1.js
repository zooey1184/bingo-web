...
function loaddefaultcontent( topic_id, ability ){
		...
		$.get('/lib/mybingo/getNewAbilityMaterialsList.xml?testService=ability&ability='+ability+'&topic='+topic_id + '&bingoBand=1&ran=' + ran, function(data){
		$('#materials').empty();
		$('#materials').unblock();
...
/*
		...
		*/		
		...
		$(document).ready(function(){
		   $.get('/lib/vocbook/getvoccount.xml?topic=' + topic_id + '&band=21', function(data){
		      ...
		      var tb_4_html = "<td valign='top'><div id='div_choose_level'><a href='#null' onclick='block_with_choose()'><img src='/st/images/ability/level_1.gif' border=0/></a></div></td>";
		      ...
		      if(global_online == 'true'){
		        $('#vocMenu').find('td:eq(2)').click(function(){
		          window.open("/lib/vocbook/index.do?topic="+topic_id+"&band=21&org=ability1","_self");
		                     });
		                }
