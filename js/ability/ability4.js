...
function loaddefaultcontent( topic_id, ability ){
		...
		$.get('/lib/mybingo/getNewAbilityMaterialsList.xml?testService=cet6&ability='+ability+'&topic='+topic_id + '&bingoBand=4&ran=' + ran, function(data){
		$('#materials').empty();
		$('#materials').unblock();
				...
				$items.each(function(index_id){
					...
					if(global_online == 'true'){
						if(global_ip_valid == 'true' || global_sn_valid == true){
					   		if(finished == 'false'){
					      		divHTML += "<div class='link_out'><a href='" + url + "&testService=ability"  +"' target='_blank'><img src='/st/images/gaokao_1/tools/begin.gif' border=0/></a></div>";
					        }else{			
					      		divHTML += "<div class='link_out'>"
					      		divHTML += "得分：" + score +"<br />";
				      			divHTML +="<a href='" + url + "&testService=ability" +"' target='_blank'><img src='/st/images/gaokao_1/tools/redo.gif' border=0/></a><br/>";
...
/*	
		$(data).find('history').each( function(){
			...
			if( item_length > 0 ) {
				var divHTML = "已完成题目:<div class='history_item'><br />";
				divHTML += "<div class='abilityName'><div class='abilityNameContent'>" + name + "</div><div class='abilityNameIntro'>" + strIntro + "</div></div>";
				divHTML +="<div class='detailAbilityContent'>";
				$items.each(function(){
					var $item = $(this);
					...
					divHTML += "<div class='link_out'>"
					divHTML += "得分：" + score +"<br />";
					divHTML +="<a href='" + url + "&testService=cet6" +"' target='_blank'><img src='/st/images/gaokao_1/tools/redo.gif' border=0/></a><br/>";
					divHTML += "<a href='" + redo_url +"' target='_blank'><img src='/st/images/gaokao_1/tools/review.gif' border=0/></a></div>";
					divHTML += "<div class='cleared'></div>";
					divHTML += "</div>";
				});
		...
		*/
		...
		$(document).ready(function(){
		   $.get('/lib/vocbook/getvoccount.xml?topic=' + topic_id + '&band=24', function(data){
		      var vocCount = $(data).find('voc_count').text();
		      
		      var topicHTML ="<table width='100%'><tr>";
		      var tb_1_html = "<td  width='50'>" + $('td:eq(0)',$topicTbody).html() +"</td>";
	      	var tb_2_html = "<td>" +$('td:eq(1)',$topicTbody).html()+"</td>";
         	var tb_3_html = "<td><div id='div_vocbooklink'>" + vocCount +"</div></td>";
			var tb_4_html = "<td valign='top'><div id='div_choose_level'><a href='#null' onclick='block_with_choose()'><img src='/st/images/ability/level_4.gif' border=0/></a></div></td>";
		      topicHTML += tb_1_html + tb_2_html + tb_3_html + tb_4_html;
		      ...
		      if(global_online == 'true'){
		        $('#vocMenu').find('td:eq(2)').click(function(){
		          window.open("/lib/vocbook/index.do?topic="+topic_id+"&band=24&org=ability4","_self");
		                     });
		                }
...
function init_buy() {
	...
	strHTML +="<div class='alertmsg'><table><tr><td><img src='/st/images/gaokao_1/account/forbid.png' border='0'></td><td align='right'>您还没有购买该产品<br />或者您的服务已经到期，请先购买<br/><hr class='dashedhr'/><a href='/lib/account/ability/index.do' target='_self'><img src='/st/images/buy.gif' border='0'/></a></td></tr></table><div>";
...
chooseHTML += "<div id='div_choose' style='display:none;border-style:dashed;border-width:1px;border-color:#bee4fc;padding:10px;margin:10px;text-align:left;font-family:新宋体'>";
chooseHTML +="<div>";
chooseHTML += "<table width='98%' cellspacing='0' cellpadding='1' align='left' id='m_target_table'>";
		
chooseHTML += "       <tbody>";
chooseHTML += "        	<tr><td colspan='2'>";
chooseHTML += "            <div class='topic_heaer_text'>";
chooseHTML += "            	请选择能力级别";
chooseHTML += "            </div>";    
chooseHTML += "            </td></tr>";
chooseHTML += "        </tbody>";
chooseHTML += "		<tbody id='/st/ability/level_1.html'>";
chooseHTML += "			<tr><td align='left' width='88' height='47'><img src='/st/images/index_1/p1.jpg' width='88' height='47' border='0'/></td><td align='right'>冰果一级<br/>初中水平</td>";
chooseHTML += "		  </tr>";
chooseHTML += "          <tr><td colspan='2'><hr class='dashedhr' /></td></tr>";
chooseHTML += "        </tbody>";
chooseHTML += "        <tbody  id='/st/ability/level_2.html'>"; 
chooseHTML += "			<tr><td align='left'><img src='/st/images/index_1/p2.jpg' width='88' height='47' border='0'/></td><td align='right'>冰果二级<br/>高中水平</td></tr>";
chooseHTML += "            <tr><td colspan='2'><hr class='dashedhr' /></td></tr>";
chooseHTML += "        </tbody>";
chooseHTML += "        <tbody id='/st/ability/level_3.html'>";    
chooseHTML += "			<tr><td align='left'><img src='/st/images/index_1/p3.jpg' width='88' height='47' border='0'/></td><td align='right'>冰果三级<br/>大学水平</td></tr>";
chooseHTML += "            <tr><td colspan='2'><hr class='dashedhr' /></td></tr>";
chooseHTML += "        </tbody>";
chooseHTML += "        <tbody  id='/st/ability/level_4.html'>";   
chooseHTML += "			<tr><td align='left'><img src='/st/images/index_1/p4.jpg' width='88' height='47' border='0'/></td><td align='right'>冰果四级<br/>研究生水平</td></tr>";
chooseHTML += "            <tr><td colspan='2'><hr class='dashedhr' /></td></tr>";
chooseHTML += "        </tbody>";
 
chooseHTML += "        </table>";
chooseHTML += "</div>";
chooseHTML += "<div id='close' style='text-align:center;clear:both;'><img src='/st/images/close.gif'/></div>";
	
chooseHTML += "        </div>";

$(chooseHTML).prependTo('body');

init_m_target();
	
	$('#div_choose').find('#close').click(function(){
	   $('body').unblock();
	});	
...
function init_m_target(){
	$('#m_target_table tbody').each( function(){
		var $tbody = $(this);
