$(document).ready(function(){
  $('#products_div').empty();
  $.get('/st/xml/graduate_types.xml', showTypes);
  init_login();
  init_buy();   
  locate_type();  
});              

var global_exam = "graduate";
...
function init_buy() {
	...
	strHTML +="<div class='alertmsg'><table><tr><td><img src='/st/images/gaokao_1/account/forbid.png' border='0'></td><td align='right'>您还没有购买该产品或者您的服务已经到期，请先购买<br/><hr class='dashedhr'/><a href='/lib/account/graduate/index.do' target='_self'>购买</a></td></tr></table><div>";
