...
function getWords(page){
   ...
   $.get('/e/daily/widgetwords.xml?page=' + page, function(data){
   
      var HTML = ""; 
      HTML +="<ul>"
      $(data).find('item').each(function(index){
          HTML = HTML + "<li>" + "<a href=\"javascript:tb_show('words','/e/daily/words.html?serialNumber=" + $(this).find('serialNumber').text() + "&KeepThis=true&TB_iframe=true&height=600&width=600','')\">" 
...
function getNews(page){
   ...
   $.get('/e/daily/widgetnews.xml?page=' + page, function(data){
   
      var HTML = ""; 
      HTML +="<ul>"
      $(data).find('item').each(function(index){
          HTML = HTML + "<li>" + "<a href=\"javascript:tb_show('news','/e/daily/news.html?serialNumber=" + $(this).find('serialNumber').text() + "&KeepThis=true&TB_iframe=true&height=600&width=600','')\">" 
...
function getSongs(page){
   ...
   $.get('/e/daily/widgetsongs.xml?page=' + page, function(data){
   
      var HTML = ""; 
      HTML +="<ul>"
      $(data).find('item').each(function(index){
          HTML = HTML + "<li>" + "<a href=\"javascript:tb_show('songs','/e/daily/songs.html?serialNumber=" + $(this).find('serialNumber').text() + "&KeepThis=true&TB_iframe=true&height=600&width=600','')\">" 
          + (page*5+index + 1) + "." + $(this).find('title').text() + "</a>"; 
                });
      HTML +="</ul>"          
      HTML = HTML + "<br>";
...
function getWhichs(page){
   ...
   $.get('/e/daily/widgetwhich.xml?page=' + page, function(data){
   
      var HTML = ""; 
      HTML +="<ul>"
      $(data).find('item').each(function(index){
          HTML = HTML + "<li>" + "<a href=\"javascript:tb_show('words','/e/daily/which.html?serialNumber=" + $(this).find('serialNumber').text() + "&KeepThis=true&TB_iframe=true&height=600&width=600','')\">" 
          + (page*5+index + 1) + "." + $(this).find('title').text() + "</a>"; 
                });
      HTML +="</ul>"          
      HTML = HTML + "<br>";
...
function getVideos(page){
   ...
   $.get('/e/daily/widgetvideo.xml?page=' + page, function(data){
   
      var HTML = ""; 
      HTML +="<ul>"
      $(data).find('item').each(function(index){
          HTML = HTML + "<li>" + "<a href=\"javascript:tb_show('words','/e/daily/videos.html?serialNumber=" + $(this).find('serialNumber').text() + "&KeepThis=true&TB_iframe=true&height=600&width=600','')\">" 
          + (page*5+index + 1) + "." + $(this).find('title').text() + "</a>"; 
                });
      HTML +="</ul>"          
      HTML = HTML + "<br>";
