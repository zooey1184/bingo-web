$(document).ready(function(){
  $('#products_div').empty();
  $.get('/st/xml/gaokao_types.xml', showTypes);   
  init_login();
  init_buy();
});              

var global_exam = "gaokao";
var global_type = "nationalrealtest";
...
function init_buy() {
	...
	strHTML +="<div class='alertmsg'><table><tr><td><img src='/st/images/gaokao_1/account/forbid.png' border='0'></td><td align='right'>您还没有购买该产品<br />或者您的服务已经到期，请先购买<br/><hr class='dashedhr'/><a href='/e/account/gaokao/index.do' target='_self'><img src='/st/images/buy.gif' border='0'/></a></td></tr></table><div>";
