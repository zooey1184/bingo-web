export default {
  props: {
    ...
    images: {
      type: Array,
      default: () => [
        '/st/images/home/edu1.png',
        '/st/images/home/edu2.png',
        '/st/images/home/edu3.png',
        '/st/images/home/edu4.png'
      ]
    }
  },
  methods: {
    ...
    <div style="margin: 32px auto; max-width: 1200px;" class="p-32 ">
      <div :class='{"flex flex-wrap": size > 980}' class="overflow-hidden  justify-between bg-red-10 rounded-16 mt-32 jiaocaiPane"
        ...
        <div class="flex mr-32 overflow-hidden">
          <img :src="images[0]" class='eduItem_20' alt="" srcset="">
          <img :src="images[1]" class='eduItem_20' alt="" style='margin-left: -10px' srcset="">
          <img :src="images[2]" class='eduItem_30' style='margin-left: -20px'  alt="" srcset="">
          <img :src="images[3]" class='eduItem_30' style='margin-left: -10px' alt="" srcset="">
        </div>
