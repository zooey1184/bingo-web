export default [
  ...
  //     // btnGroups: [
  //     //   { name: '渠道合作', url: 'https://www.bingoenglish.com/apply/agent', class: 'bg-orange' },
  //     //   { name: '产品购买', url: 'https://www.bingoenglish.com/apply/school', class: 'bg-red' }
  //     // ]
  //   },
  //   subNavs: [
  //     {
    ...
    subNavs: [
      {
        ...
        subNavs: [
          ...
          {
            name: '外教博客',
            url: 'http://www.bingoenglish.com/blog/Huffmans/'
          },
          { name: '专题', url: 'https://www.bingoenglish.net/content/special/index.php' }
        ]
      },
      {
        name: '娱乐',
